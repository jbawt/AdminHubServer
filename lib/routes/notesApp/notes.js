...
module.exports = (db) => {
  ...
  router.post('/create-note', (req, res) => {
    ...
    if (verified) {
      ...
      db.query('INSERT INTO notes (user_id, title, description, archive, image, time, reminder) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING *;', [claim.id, title, description, archive, image, time, reminderDate])
        .then(data => {
