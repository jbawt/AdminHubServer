...
module.exports = (db) => {
  ...
  router.get('/files', async (req, res) => {
    ...
    const driveFiles = await drive.files.list({ q: "trashed=false and 'root' in parents", fields: 'files(id, name, size, modifiedTime, mimeType, createdTime, owners, fileExtension, thumbnailLink)' });
    ...
    const resArr = files.filter(file => file !== null);
